        ...
        <React.Fragment>
            <Col xs={{ span: 12 }} lg={{ span: 6 }}>
                <Form.Group controlId={props.controlDataId}>
                    ...
                    <Form.Control onBlur={checkDate} type="date" placeholder={props.placeholderData} min={new Date().toISOString().substring(0, 10)} max={maxDate} pattern="[0-9]{4}-[0-1][0-9]-[0-3][0-9]" required />
                </Form.Group>
            </Col>
            <Col xs={{ span: 12 }} lg={{ span: 6 }}>
                <Form.Group controlId={props.controlOrarioId}>
                    <Form.Label>{props.labelOrario}</Form.Label>
                    <Form.Control as="select" classe="form-select" required={props.required}>
